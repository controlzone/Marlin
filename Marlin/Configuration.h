...
#define STRING_CONFIG_H_AUTHOR "(Greg, initial config)" // Who made the changes.
...
#define EXTRUDER_WATTS (12.0*12.0/5.7) //  P=V^2/R
#define BED_WATTS (12.0*12.0/1.2)      // P=V^2/R
